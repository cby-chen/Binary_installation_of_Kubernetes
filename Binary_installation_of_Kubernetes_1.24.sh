...
export lb_01="192.168.1.67"
export lb_02="192.168.1.68"
export lb_vip="192.168.1.69"
...
export IP="k8s-master01 k8s-master02 k8s-master03 k8s-node01 k8s-node02 k8s-node03 lb01 lb02"
export other="k8s-master02 k8s-master03 k8s-node01 k8s-node02 k8s-node03 lb01 lb02"
export k8s_other="k8s-master02 k8s-master03 k8s-node01 k8s-node02 k8s-node03"
export k8s="k8s-master01 k8s-master02 k8s-master03 k8s-node01 k8s-node02 k8s-node03 "
...
kubectl config set-cluster kubernetes      --certificate-authority=/etc/kubernetes/pki/ca.pem     --embed-certs=true      --server=https://$vip:8443      --kubeconfig=/etc/kubernetes/kube-proxy.kubeconfig
...
EOF"
    ...
    ssh root@$HOST "sed -i \"s#k8s.gcr.io#registry.cn-hangzhou.aliyuncs.com/chenby#g\" /etc/containerd/config.toml"
